...
function GamePolicy(){
    ...
    this.leftBorderX = BORDER_SIZE*0.90;
    this.rightBorderX = Game.size.x - (BORDER_SIZE * 1.02);
    this.topBorderY = BORDER_SIZE*0.92;
    this.bottomBorderY = Game.size.y - (BORDER_SIZE*0.35);

    this.topCenterHolePos = new Vector2(746, 150);
    this.bottomCenterHolePos = new Vector2(753, 769);
    this.topLeftHolePos = new Vector2(168, 168 );
    this.topRightHolePos = new Vector2(1317, 178);
...
GamePolicy.prototype.drawScores = function(){
    Canvas2D.drawText("PLAYER " + (this.turn + 1), new Vector2(Game.size.x / 2 + 40000, 200), new Vector2(150, 0), "#096834", "top", "Impact", "70px");
...
GamePolicy.prototype.updateTurnOutcome = function(){
    ...
    setTimeout(function(){Game.gameWorld.whiteBall.visible=true;}, 10);
